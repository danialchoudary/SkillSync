            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-[var(--color-text-tertiary)]">
                  {selectedUser.role === 'recruiter' ? 'Recruiter' : 'Job Seeker'} - {isUserOnline ? 'Active now' : 'Offline'}
                </p>
              </div>
            </div>
          </div>
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center h-full">
                <div className="w-16 h-16 bg-[var(--color-surface-secondary)] rounded-full flex items-center justify-center mb-3">
                  <span className="text-sm font-semibold text-[var(--color-text-tertiary)]">CHAT</span>
                </div>
