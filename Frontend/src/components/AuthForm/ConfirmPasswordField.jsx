...
export default function ConfirmPasswordField({ value, onChange, showPassword, setShowPassword }) {
  return (
    <div className="space-y-1.5">
      <label className="block text-[11px] font-bold text-[var(--color-text-secondary)] uppercase tracking-wider ml-1">Confirm Password</label>
