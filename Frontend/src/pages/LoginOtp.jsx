      ...
      >
        <div className="bg-[var(--color-surface)] rounded-xl border border-[var(--color-border)] shadow-[var(--shadow-sm)] overflow-hidden">
          <div className="px-6 pt-8 pb-4 text-center">
            ...
            <h1 className="text-xl font-semibold text-[var(--color-text-primary)] mb-1">Sign in</h1>
            <p className="text-sm text-[var(--color-text-secondary)]">Legacy email, password, and phone verification flow</p>
          </div>
